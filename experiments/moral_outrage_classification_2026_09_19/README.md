...
Scoring uses one stratified random sample of 1,000 tweets, not the full 26,000-row file. Jev and Bedrock smoke classify three fixed texts. Perspective smoke reads three stored labeled rows. The 1,000-row jobs do not start until someone approves the smoke table.
