...
export const metadata: Metadata = {
  title: "Turing-RL replica dashboard",
  description:
    "A small replica of Learning User Simulators with Turing Rewards, with paper numbers, dummy-data GRPO, and an interactive judge.",
}
